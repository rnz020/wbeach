                    ...
                    <div class="tab-content br-n pn">
                      ...
                      <div id="nav-tab2" class="tab-pane chat-widget" role="tabpanel">
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?= asset("img/avatars/3.jpg") ?>">
                            </a>
                          </div>
                          <div class="media-body">
                      ...
                      <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                        <ul class="media-list" role="menu">
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= asset("img/avatars/5.jpg") ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= asset("img/avatars/2.jpg") ?>"class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= asset("img/avatars/3.jpg") ?>"class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= asset("img/avatars/4.jpg") ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading mv5">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
            ...
            <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                <li class="dropdown-header clearfix">
                    ...
                    <div class="pull-left ml10">
                       <select id="user-status" style="display: none;">
                        ...
                        <div class="btn-group" style="width: 100px;">
                            <button type="button" class="multiselect dropdown-toggle btn btn-default btn-sm" data-toggle="dropdown" title="Online" style="width: 100px;">
                                Online <b class="caret"></b>
                            </button>
                            <ul class="multiselect-container dropdown-menu">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <label class="radio"><input type="radio" value="1-1"> Away</label>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">
                                        <label class="radio"><input type="radio" value="1-2"> Offline</label>
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="javascript:void(0);"><label class="radio"><input type="radio" value="1-3"> Online</label>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="pull-right mr10">
                        ...
                        <div class="btn-group" style="width: 100px;">
                            <button type="button" class="multiselect dropdown-toggle btn btn-default btn-sm" data-toggle="dropdown" title="Admin" style="width: 100px;">
                                Admin 
                                <b class="caret"></b>
                            </button>
                            <ul class="multiselect-container dropdown-menu pull-right">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <label class="radio"><input type="radio" value="1-1"> Client</label>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">
                                        <label class="radio"><input type="radio" value="1-2"> Editor</label>
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="javascript:void(0);">
                                        <label class="radio"><input type="radio" value="1-3"> Admin</label>
                                    </a>
                                </li>
                            </ul>
                        </div>
